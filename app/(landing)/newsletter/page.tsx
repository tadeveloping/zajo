...
export default function NewsletterPage() {
  ...
  useEffect(() => { trackStep('newsletter', 'view') }, [])

  function onType(setter: (v: string) => void, val: string) {
    if (!startedTyping.current && val.trim()) {
      startedTyping.current = true
      trackStep('newsletter', 'started_typing')
    }
    setter(val)
  }
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(false)
    trackStep('newsletter', 'submitted')
    setDone(true)
  }
              ...
              <form id="nlForm" noValidate onSubmit={handleSubmit}>
                <div className="form-group">
                  ...
                  <input
                    ...
                    value={meno} onChange={e => onType(setMeno, e.target.value)}
                  />
                </div>
                <div className="form-group">
                  ...
                  <input
                    ...
                    value={email} onChange={e => { onType(setEmail, e.target.value); setErrors(ev => ({ ...ev, email: '' })) }}
                  />
        ...
        <div className="why-inner">
          ...
          <div className="why-grid">
            ...
            <div className="why-item">
              ...
              <div>
                <h3>Trendy trhu</h3>
                <p>Prehľad vývoja cien v lokalitách Trenčianskeho kraja, aby ste vedeli, kedy je správny čas kupovať.</p>
              </div>
            </div>
            <div className="why-item">
