...
function buildPreviewHtml(c: NewsletterContent): string {
  ...
  <div style="max-width:600px;margin:0 auto;background:#FFF;border-radius:12px;box-shadow:0 4px 32px rgba(0,0,0,0.1);overflow:hidden;">
    <div style="background:#F7911D;padding:12px 32px;border-radius:12px 12px 0 0;display:flex;align-items:center;justify-content:space-between;">
      <img src="${LOGO_URL}" alt="ZAJO Reality" style="height:80px;width:80px;display:block;border-radius:6px;"/>
