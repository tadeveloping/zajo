                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="background:#FFF6EB;border-left:3px solid #E8711A;border-radius:6px;">
                    ...
                    <tr>
                      <td style="padding:14px 22px 18px;">
                        ...
                        <div style="font-family:'Segoe UI',Arial,sans-serif;color:#3D3530;font-size:14px;line-height:1.55;">V pracovné dni vás osobne kontaktujeme. Ozve sa vám priamo Tomáš — bez automatických odpovedí a presúvania.</div>
                      </td>
                    </tr>
                  </table>
                </td>
